        ...
        <div className="relative bg-ink-900 rounded-sm overflow-hidden px-8 py-16 md:p-20 text-center border border-accent-600/30">
          ...
          <div className="relative">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="#"
                className="group px-7 py-3.5 bg-cream-100 hover:bg-white text-ink-900 text-sm font-medium rounded-sm transition-all inline-flex items-center justify-center gap-2 font-sans"
              >
              ...
              <a
                href="#"
                className="px-7 py-3.5 bg-cream-100/10 hover:bg-cream-100/20 backdrop-blur text-cream-100 text-sm font-medium rounded-sm border border-cream-100/20 transition-all font-sans"
              >
                Book a demo
              </a>
            </div>
