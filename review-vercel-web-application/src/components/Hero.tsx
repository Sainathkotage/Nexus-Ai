      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-3 justify-center items-center animate-fade-in-up delay-300">
            <a
              href="#pricing"
              className="group px-7 py-3.5 bg-ink-900 hover:bg-accent-600 text-cream-100 text-sm font-medium rounded-sm transition-all inline-flex items-center gap-2 shadow-lg shadow-ink-900/20 font-sans"
            >
