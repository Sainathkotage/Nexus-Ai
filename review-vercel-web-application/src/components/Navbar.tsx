    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-2">
          <a
            href="#"
            className="px-4 py-2 text-sm text-ink-700 hover:text-accent-600 transition-colors font-sans"
          >
            Sign in
          </a>
          <a
            href="#pricing"
            className="group px-5 py-2 text-sm font-medium text-cream-100 bg-ink-900 hover:bg-accent-600 rounded-sm transition-all inline-flex items-center gap-1 font-sans border border-ink-900"
          >
            Get started
      ...
      {open && (
        <div className="md:hidden bg-cream-100/95 backdrop-blur-xl border-t border-ink-900/10 mt-3">
          <div className="px-6 py-4 flex flex-col gap-1">
            ...
            <a
              href="#pricing"
              className="mt-2 px-4 py-2.5 text-sm font-medium text-cream-100 bg-ink-900 rounded-sm text-center font-sans"
              onClick={() => setOpen(false)}
            >
              Get started
            </a>
