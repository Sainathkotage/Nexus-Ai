            ...
            <div className="space-y-6 animate-fadeIn text-xs">
              <div className="flex flex-col gap-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Link external services and developer platforms to sync messages, files, PRs, and issues.</p>
                </div>
                <div className="h-px bg-border" />
                
                <div className="p-6 border border-border bg-gradient-to-br from-indigo-500/5 via-purple-500/5 to-transparent rounded-3xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6 shadow-sm relative overflow-hidden mt-2">
                  <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500/5 rounded-full blur-3xl pointer-events-none" />
                  <div className="space-y-2 relative z-10 max-w-xl">
                    <div className="w-10 h-10 rounded-xl bg-indigo-500/10 flex items-center justify-center border border-indigo-500/20 text-indigo-500 mb-2">
                      <Plug className="w-5 h-5" />
                    </div>
                    <h3 className="text-sm font-bold text-foreground">Dedicated Integrations Hub</h3>
                    <p className="text-3xs text-muted-foreground leading-relaxed">
                      We have upgraded our integration manager! Easily connect Slack, GitHub, Notion, and Jira workspaces with one-click OAuth authentication, map automations workflows, and inspect live sync history.
                    </p>
                  </div>
                  <Button
                    type="button"
                    onClick={() => window.location.href = '/integrations'}
                    className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-full h-8 text-3xs px-4 flex items-center gap-1.5 cursor-pointer relative z-10 shrink-0"
                  >
                    Open Integrations Hub <ArrowUpRight className="w-3.5 h-3.5" />
                  </Button>
                </div>
              </div>
            </div>
